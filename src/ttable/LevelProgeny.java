 ...
 * the child's progress details and the level settings that are set for that child alone.
 * 
...
public class LevelProgeny {
	...
	/**
	 * Sets the time it took to complete the drill on the first time it was passed.
	 *
